...
export const it: Record<string, string> = {
  ...
  "inspector.columnsSelected": "{n, plural, one {# colonna selezionata} other {# colonne selezionate}}",
  "inspector.includeSelected": "{n, plural, one {Includi # colonna} other {Includi # colonne}}",
  "inspector.removeSelected": "{n, plural, one {Rimuovi # colonna} other {Rimuovi # colonne}}",
