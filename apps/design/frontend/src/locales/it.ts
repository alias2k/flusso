...
export const it: Record<string, string> = {
  ...
  "sidebar.schemaDir": "Directory",
  "sidebar.rootDir": "(radice — directory di flusso.toml)",
  "sidebar.schemaFile": "File schema",
  "sidebar.schemaFileHint": "Scegli una directory (o scrivine una nuova) e un nome file.",
  "sidebar.overrideName": "Personalizza il nome completo del file",
  "sidebar.lockSuffix": "Usa il suffisso standard .schema.yml",
  ...
  "inspector.columnsSelected": "{n, plural, one {# riga selezionata} other {# righe selezionate}}",
  "inspector.includeSelected": "{n, plural, one {Includi # colonna} other {Includi # colonne}}",
  "inspector.removeSelected": "{n, plural, one {Rimuovi # riga} other {Rimuovi # righe}}",
  ...
  "inspector.variants": "Varianti (ordinate)",
  "inspector.variantsHint":
    "Elenca i valori in ordine di rango — il campo viene ordinato secondo questo ordine anziché alfabeticamente. Lascia vuoto per un enum semplice.",
  "inspector.variantsAdd": "Aggiungi una variante…",
  "inspector.add": "Aggiungi",
  "inspector.variantUp": "Sposta su",
  "inspector.variantDown": "Sposta giù",
  "inspector.variantRemove": "Rimuovi variante",
  ...
  "config.streamHint": "tra l'origine e le destinazioni",
  "config.options": "opzioni",
  "config.required": "obbligatorio",
  "config.default": "predefinito",
  "config.literal": "letterale",
  "config.env": "variabile env",
  "config.parts": "componenti",
  "config.loadingAdapters": "caricamento adapter…",
  "config.unknownAdapter": 'Nessun adapter registrato per il tipo "{kind}"',
