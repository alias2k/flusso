...
export const it: Record<string, string> = {
  ...
  "inspector.srcNullable": "Colonna che ammette null — facoltativa per impostazione predefinita; per renderla obbligatoria devi impostare un valore predefinito.",
  "inspector.secIdentity": "Identità",
  "inspector.secSource": "Origine",
