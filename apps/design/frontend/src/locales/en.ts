...
export const en: Record<string, string> = {
  ...
  "inspector.srcNullable": "Nullable column — optional by default; to make it required you must set a default.",
  "inspector.secIdentity": "Identity",
  "inspector.secSource": "Source",
