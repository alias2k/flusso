...
//! - the deployment's declared [`Tls`] (the flat `ssl_*` keys in
...
pub fn sql_connection_url(connection_url: &str, tls: &Tls) -> Result<String, SourceError> {
...
fn resolve_tls(url: &Url, tls: &Tls) -> Result<EffectiveTls, SourceError> {
