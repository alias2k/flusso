...
- The in-process adapter implements the watermark in memory over per-sink channels. A broker-backed adapter reads its consumers' acknowledgement floors. Nothing in the engines changes between the two.
